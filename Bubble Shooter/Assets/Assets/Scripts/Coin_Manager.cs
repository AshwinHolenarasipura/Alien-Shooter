...
public class Coin_Manager : Singleton<Coin_Manager>
{
    ...
    {
        base.Awake();
        target = GameObject.FindGameObjectWithTag("Coin_Collector_Image").transform;
    ...
    public void AddCoins(Vector3 collectedCoinPosition, int amount)
    {
        ...
        Game_Manager.Instance.OnScoreCountChange(amount);
    }
}
